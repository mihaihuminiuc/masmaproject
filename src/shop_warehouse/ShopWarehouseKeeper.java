...
import shop_warehouse.service.WarehouseKeeperRegister;
import shop_warehouse.service.WarehouseReceive;
...
public class ShopWarehouseKeeper extends Agent {
    ...
    public void setup() {
        ...
        addBehaviour(new WarehouseKeeperRegister(this));
        addBehaviour(new WarehouseReceive(this));
    }
}
